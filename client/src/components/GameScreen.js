          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-200 text-sm">Round {roundNumber}</p>
              </div>
            </div>
            ...
            {phase !== 'gameOver' && (
              <div className="flex items-center space-x-4">
                {prayerPaused && (
                  <div className="bg-green-900/50 px-4 py-2 rounded-lg border border-green-500/50">
                    <p className="text-green-200 text-sm">🕌 Prayer Time Paused</p>
                  </div>
                )}
                ...
                <div className="text-right">
                  ...
                  <p className="text-purple-200 text-xs">Time Remaining</p>
                </div>
                ...
                >
                  {prayerPaused ? <Play className="w-5 h-5 text-white" /> : <Pause className="w-5 h-5 text-white" />}
                </button>
              </div>
            )}
            ...
            <div className="text-right">
              ...
              <p className="text-white font-bold text-lg">{roomCode}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Dead Player Notice */}
            {!isAlive && (
              <div className="bg-gray-900/50 border-2 border-red-500 rounded-lg p-6 text-center">
